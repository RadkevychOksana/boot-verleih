            ...
            <div class="col-12 col-sm-4 mb-5">
                <?php if (!isset($_COOKIE['user'])) { ?>
                    <div class="contact-form">
                        ...
                        <form action="src/auth.php" method="post" name="eingang" id="eingang" novalidate="novalidate">
                    ...
                    <?php } else { ?>
                        <p><strong><?= $_COOKIE['user'] ?> </strong> 👌 Angemeldet <a href="src/logout.php">Ausgang</a></p>
                    <?php } ?>
                    </div>
            </div>
        </div>
